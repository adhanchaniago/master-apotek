							...
							<div id="add" class="modal fade" role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<?= form_open('jenis-obat/tambah-data') ?>
										<div class="modal-body">
											<div class="row">
												<?php if($Level="IT Support" OR $Level="Owner") : ?>
													<div class="col-lg-12">
														<label>Nama Jenis</label>
														<?= form_input('nm_jenis',null,array('class' => 'form-control','placeholder' => 'Nama Jenis')) ?>
													</div>
												<?php else : ?>
													<div class="col-lg-12">
														<label>Nama Jenis</label>
										...
										<?php foreach($Data as $l) : ?>
											<tr>
												...
												<td class="text-center">
													<div class="btn-group">
														<button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#edit-<?= $l->id_jenis ?>">Edit</button>
														<button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#del-<?= $l->id_jenis ?>">Delete</button>
													</div>
												</td>
											</tr>
											<div id="edit-<?= $l->id_jenis ?>" class="modal fade" role="dialog">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header bg-yellow">
															<h4 class="modal-title">Form Edit <?= $l->nm_jenis ?></h4>
														</div>
														<?= form_open('jenis-obat/edit-data/'.$l->id_jenis) ?>
														<div class="modal-body">
															<div class="row">
																<?php if($Level="IT Support" OR $Level="Owner") : ?>
																	<div class="col-lg-6">
																		<label>Nama Jenis</label>
																		<?= form_input('nm_jenis',$l->nm_jenis,array('class' => 'form-control')) ?>
																	</div>
																<?php else : ?>
																	<div class="col-lg-6">
																		<label>Nama Jenis</label>
											...
											<div id="del-<?= $l->id_jenis ?>" class="modal fade" role="dialog">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header bg-red">
															<h4 class="modal-title">Konfirmasi Menghapus <?= $Title ?></h4>
														</div>
														<?= form_open('jenis-obat/del-data/'.$l->id_jenis) ?>
														<div class="modal-body">
